...
import { Page, Navbar, List, ListItem, Icon, BlockTitle } from 'framework7-react';
	...
	render() {
		return (
			<Page name="settings">
				...
				<List inset={this.$f7.theme === 'aurora'} noHairlinesBetweenAurora>
					<ListItem link="/" title="Library" view=".view-main" panelClose>
						<div slot="media" className="sidebar-media sb-media-first">
							<Icon
								ios="f7:square_grid_2x2_fill"
								md="material:view_module"
								aurora="f7:square_grid_2x2_fill"
							/>
						</div>
					</ListItem>
					<ListItem link="/game-hub/" title="Game Hub" view=".view-main" panelClose>
						<div slot="media" className="sidebar-media sb-media-second">
							<Icon
								ios="f7:square_stack_3d_up_fill"
								md="material:view_carousel"
								aurora="f7:square_stack_3d_up_fill"
							/>
						</div>
					</ListItem>
				...
				<List inset={this.$f7.theme === 'aurora'} noHairlinesBetweenAurora>
					{global.eclipse.systems.map(res => (
						<ListItem
							key={res.id}
							link={`/system/${res.name.short.toLowerCase()}`}
							title={res.name.short}
							view=".view-main"
							panelClose
						>
